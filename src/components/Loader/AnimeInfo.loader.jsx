    ...
    return (
        <>
            <div className="relative grid grid-cols-[minmax(0,75%),minmax(0,25%)] h-fit w-full overflow-hidden mt-[64px] max-[1200px]:flex max-[1200px]:flex-col max-md:mt-[50px]">
                <Skeleton className="absolute inset-0 w-full h-full blur-lg z-[-900] bg-black" animation={false} />
                <div className="flex items-start z-10 px-14 py-[70px] bg-black bg-opacity-80 gap-x-8 max-[1024px]:px-6 max-[1024px]:py-10 max-[1024px]:gap-x-4 max-[575px]:flex-col max-[575px]:items-center max-[575px]:justify-center">
                    ...
                    <div className="flex flex-col ml-4 gap-y-5 w-full max-[575px]:items-center max-[575px]:justify-center max-[575px]:mt-0">
                        ...
                        <div className="flex gap-x-4 items-center mt-4">
                            <Skeleton className="w-[60px] h-[60px] rounded-full bg-[#2a2a2a] max-[575px]:hidden" />
                    ...
                    <div className="w-full flex flex-col h-fit gap-y-4">
                        ...
                        <div className="flex gap-x-4 py-2 mt-4">
                            ...
                            <div className="flex flex-wrap gap-1">
                                <SkeletonItems count={4} className="w-[30px] h-[20px] rounded-sm bg-[#2a2a2a]" />
                            </div>
                        </div>
